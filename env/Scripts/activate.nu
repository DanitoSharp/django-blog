...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\Daniel Ekeleme\Desktop\Django\django-blog\env'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\Daniel Ekeleme\Desktop\Django\django-blog\env\Scripts\deactivate.nu'
